...
import com.turing.springbootintegrate.common.utils.callback.MethodCallback;
import com.turing.springbootintegrate.common.utils.collect.ListUtils;
import com.turing.springbootintegrate.common.utils.excel.annotation.ExcelField;
import com.turing.springbootintegrate.common.utils.excel.annotation.ExcelField.Type;
import com.turing.springbootintegrate.common.utils.excel.annotation.ExcelFields;
import com.turing.springbootintegrate.common.utils.lang.DateUtils;
import com.turing.springbootintegrate.common.utils.reflect.ReflectUtils;
...
public class ImportExcel implements Closeable{
	 ...
	 * @throws IOException 
	 */
	public ImportExcel(File file) throws InvalidFormatException, IOException {
		this(file, 0, 0);
	}
	 ...
	 * @throws IOException 
	 */
	public ImportExcel(File file, int headerNum, Object sheetIndexOrName) 
			throws InvalidFormatException, IOException {
	 ...
	 * @throws IOException 
	 */
	public ImportExcel(MultipartFile multipartFile, int headerNum, Object sheetIndexOrName) 
			throws InvalidFormatException, IOException {
	 ...
	 * @throws IOException 
	 */
	public ImportExcel(String fileName, InputStream is, int headerNum, Object sheetIndexOrName) 
			throws InvalidFormatException, IOException {
